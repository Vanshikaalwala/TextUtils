...
export default function About(props) {
    ...
    let myStyle= {
        ...
        backgroundColor: props.mode==="dark"?"rgb(44 38 90)":"white"
    }

  return (
    <div className="container" style={{color: props.mode==="dark"?"white":"#0f0d41"}}>
        ...
        <div className="accordion-item">
            ...
            <div className="accordion-body" style={myStyle}>
                TextUtils gives you a way to analyze your text quickly and efficiently. Be it word count,character count or time taken to read.
            </div>
            </div>
        </div>
        <div className="accordion-item">
        ...
        <div className="accordion-item">
            ...
            <div className="accordion-body" style={myStyle}>
                ...
                suits to count characters in facebook, blog, books, pdf document, essays,etc.
            </div>
            </div>
        </div>
        </div>
